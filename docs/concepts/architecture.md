...
/robot_segmentation[ /robot_segmentation ]:::main
/dsr01/joint_state_broadcaster[ /dsr01/joint_state_broadcaster ]:::node
/k4a_ros_device_node[ /k4a_ros_device_node ]:::node
/dsr01/dsr_controller2[ /dsr01/dsr_controller2 ]:::node
/dsr01/joint_states([ /dsr01/joint_states<br>sensor_msgs/msg/JointState ]):::topic
/leeloo/trajectory_state([ /leeloo/trajectory_state<br>std_msgs/msg/Float32 ]):::bugged
/points2([ /points2<br>sensor_msgs/msg/PointCloud2 ]):::topic
/collision_spheres([ /collision_spheres<br>visualization_msgs/msg/MarkerArray ]):::bugged
/dsr01/speedj_rt_stream([ /dsr01/speedj_rt_stream<br>dsr_msgs2/msg/SpeedjRtStream ]):::topic
/leeloo/execute_trajectory([ /leeloo/execute_trajectory<br>trajectory_msgs/msg/JointTrajectory ]):::bugged
/masked_pointcloud([ /masked_pointcloud<br>sensor_msgs/msg/PointCloud2 ]):::bugged
/trajectory([ /trajectory<br>trajectory_msgs/msg/JointTrajectory ]):::bugged


/dsr01/joint_states --> /robot_segmentation
/leeloo/trajectory_state --> /robot_segmentation
/points2 --> /robot_segmentation
/dsr01/speedj_rt_stream --> /dsr01/dsr_controller2
/robot_segmentation --> /collision_spheres
/robot_segmentation --> /dsr01/speedj_rt_stream
/robot_segmentation --> /leeloo/execute_trajectory
/robot_segmentation --> /masked_pointcloud
/robot_segmentation --> /trajectory
/dsr01/joint_state_broadcaster --> /dsr01/joint_states
/k4a_ros_device_node --> /points2
